...
echo_and_run cd "/home/mira/Robotics/turtlebot/src/Turtlebot_on_noetic/kobuki_desktop/kobuki_qtestsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mira/Robotics/turtlebot/src/Turtlebot_on_noetic/kobuki_desktop/kobuki_qtestsuite/setup.py" \
     \
    build --build-base "/home/mira/Robotics/turtlebot/build/Turtlebot_on_noetic/kobuki_desktop/kobuki_qtestsuite" \
    install \
    --root="${DESTDIR-/}" \
