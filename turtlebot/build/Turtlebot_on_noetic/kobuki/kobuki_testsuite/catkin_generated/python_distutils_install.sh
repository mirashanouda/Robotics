...
echo_and_run cd "/home/mira/Robotics/turtlebot/src/Turtlebot_on_noetic/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mira/Robotics/turtlebot/src/Turtlebot_on_noetic/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/home/mira/Robotics/turtlebot/build/Turtlebot_on_noetic/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
